...
- **ORDER NOW - Mounting Strips (shared Shopify accessory owner):** primary physical-stock listing is **-40** (`ACC-MOUNT-SINGLE`); other shared listings are -407, -12, and the two-sign pack is -14. The 13-19 July signal is 64 primary-listing units plus 2 two-sign packs, with each two-sign pack consuming 2 pairs. Amazon evidence now includes 1 delivered Ormith 48-piece mounting-pad pack from order `206-3457020-8782768` as receipt evidence. Exact order quantity/current on-hand cannot be calculated because physical on-hand baseline, reorder threshold, preferred quantity, lead time, and Ormith-to-Shopify strip equivalence are missing.
...
| Ormith Double Sided Tape Heavy Duty 48 Pcs mounting pads | 1 pack; order `206-3457020-8782768` | **DELIVERED 2026-07-20** | Mounting strips / pads evidence; receipt evidence for 48 pads, Shopify mounting-strip equivalence not confirmed | [Amazon](https://www.amazon.co.uk/dp/B0BRBS6VML) |
...
- Current physical on-hand and reorder policy for Amazon-sourced easel/keyring/thermal-label/mounting-pad items after the delivered 2026-07-20 Amazon receipts; confirm whether delivered HOMSFOU easels are an accepted substitute for the Shopify easel and whether Ormith pads map 1:1 to the Shopify mounting-strip counter.
