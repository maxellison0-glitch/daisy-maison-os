...
- **WATCH - Thermal Labels:** estimated **91 labels remaining** from the corrected 250-label baseline on 2026-07-16 less 159 Shopify orders since 2026-07-17. Reorder threshold and replacement quantity are missing; Amazon thermal-label evidence in the delivered combined order `206-3457020-8782768` is supplier receipt evidence only until the exact label quantity/type is mapped to the manual thermal-label counter.
...
- Current physical on-hand and reorder policy for Amazon-sourced easel/keyring items after the delivered 2026-07-20 Amazon receipts; confirm whether delivered HOMSFOU easels are an accepted substitute for the Shopify easel.
