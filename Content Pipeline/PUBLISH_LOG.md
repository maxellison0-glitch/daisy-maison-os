...
| DM-C025-GRAMPYS-GARAGE | Single 4:5 image — black GRAMPY'S GARAGE / OPEN 24/7 AND TOYS FIXED FOR FREE (real order #DM38588, zero-PII wording used verbatim), grandad + pegboard + pink kid's bike, pill "a real order from this week" | **POSTED to TikTok 9 Aug 2026 by the morning session (slot 1)**. publish_id `p_pub_url~v2.7671918240603342880`, `PUBLISH_COMPLETE`, public, comments on, AIGC disclosed, music "In the Spring" — Jerome Chauvel (CML `6936196880091056130`). Caption tag-a-grampy + "printed exactly as typed". **Style/hypothesis tags: FEEL-LAUGH · real-order wording x Taylors relatable-person formula — the two proven signals combined · grandad gifting lane.** | 2 credits (2 takes @ 1cr). |
| DM-C024-WEDDING-VIDEO | 5s 1080x1920 VIDEO — duskypink MR & MRS CARTER / 12TH SEPTEMBER 2026, garden reception golden hour, gentle push-in, pill "what do you get the couple who has everything?" overlaid post-animation | **POSTED to TikTok 8 Aug 2026 by the 14:30 slot Routine — first video of the volume mandate.** publish_id `v_pub_url~v2.7671672649759639585`, `PUBLISH_COMPLETE`, public, comments/duet/stitch on, AIGC disclosed, music "Venus and Flower" — Austin Farwell (CML `7603358579248171025`, vol 70, original sound muted). Motion QC: no warp, text crisp throughout. **Style/hypothesis tags: SOLVE · video vs stills test · wedding season · duskypink · Kling-turbo lane (still 2cr + animate 10cr + ffmpeg pill).** 204 views @ 16h (9 Aug snapshot) — pit pace so far. | 12 credits this post; 14 that day total. |
| DM-C023-NEW-HOME | Single 4:5 image — sage THE TAYLORS / EST. 2026, new-home hallway, pill "the last thing you put up makes it a home" (sage) | **POSTED to TikTok 8 Aug 2026 by the 10:30 slot Routine**. publish_id `p_pub_url~v2.7671608741783013408`, `PUBLISH_COMPLETE`, public, comments on, AIGC disclosed, music "Little Things" — Adrián Berenguer (CML `6981828404915996674`). Caption gifting/SOLVE job. Take 1 rejected (panel too tall); take 2 posted, hole dots patched. **Style/hypothesis tags: FEEL · single image (no filler slide) · sage vs black colour test · female presenter vs Alan-style · new-home occasion.** **717 views in ~20h (9 Aug 06:36 snapshot) — BEST SYSTEM POST EVER, beat the 710 all-time roundup; plus 1 save (Max, in-app). ⭐ AD CANDIDATE per Max's roadmap.** | 2 credits today (2 takes @ 1cr on nano_banana_2). |
| DM-C022-GARAGE | 2-slide 4:5 carousel — generated garage shot "IT'S IN THE GARAGE / SOMEWHERE" + pill "POV: you asked him where anything is" (black) → real product front photo | **POSTED to TikTok 8 Aug 2026 by the morning session (slot 1)**. publish_id `p_pub_url~v2.7671547094087321633`, `PUBLISH_COMPLETE`, public, comments on, AIGC disclosed, music "Grifting in Vegas" — Kit and the Calltones (CML `6773561197879887874`). Caption tag-a-mate job. Two inherited hole dots patched at (159,842)/(918,842) ring-median. **Style/hypothesis tags: LAUGH · generated-scene carousel · POV pill + deadpan · first post from the confirmed simple-prompt lane (Max: "sign looks real").** 350 views @ 24h (9 Aug snapshot) — above the 230-250 pit. | 7 Aug generation (4cr). |
